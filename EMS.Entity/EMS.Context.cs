...
: base(nameOrConnectionString)
        ...
        public virtual int APInvoiceFilter(Nullable<int> bankId, string periodStatus, Nullable<System.DateTime> createdDateFrom, Nullable<System.DateTime> createdDateTo, string transactionNumberFrom, string transactionNumberTo, string vendorId, string batchNumber, Nullable<int> createdBy, Nullable<bool> locationSubTotal, Nullable<bool> episodeSubTotal, Nullable<bool> exculdeOffSet, Nullable<bool> compressOffSet, Nullable<int> prodId, string status)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("APInvoiceFilter", bankIdParameter, periodStatusParameter, createdDateFromParameter, createdDateToParameter, transactionNumberFromParameter, transactionNumberToParameter, vendorIdParameter, batchNumberParameter, createdByParameter, locationSubTotalParameter, episodeSubTotalParameter, exculdeOffSetParameter, compressOffSetParameter, prodIdParameter, statusParameter);
        }
        ...
        public virtual ObjectResult<GetInvoiceListForPaymentNew_Result> GetInvoiceListForPaymentNew(Nullable<int> prodId, Nullable<int> bankId, string companyCode, string vendorID, Nullable<System.DateTime> invDate1, Nullable<System.DateTime> invDate2, string period, string paymentType)
        {
            var prodIdParameter = prodId.HasValue ?
                new ObjectParameter("prodId", prodId) :
                new ObjectParameter("prodId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetInvoiceListForPaymentNew_Result>("GetInvoiceListForPaymentNew", prodIdParameter, bankIdParameter, companyCodeParameter, vendorIDParameter, invDate1Parameter, invDate2Parameter, periodParameter, paymentTypeParameter);
        }
        ...
        public virtual ObjectResult<Nullable<int>> InsertUpdateBankInfo(Nullable<int> bankId, string bankname, Nullable<int> companyId, string address1, string address2, string address3, string city, string state, string zip, string country, string routingNumber, string accountNumber, string branchNumber, string branch, Nullable<int> clearing, Nullable<int> cash, Nullable<int> suspense, Nullable<int> bankfees, Nullable<int> deposits, Nullable<int> sourceCodeID, string currencyCode, Nullable<bool> status, Nullable<bool> postiivePay, Nullable<int> prodid, Nullable<int> createdBy)
        {
            var bankIdParameter = bankId.HasValue ?
                new ObjectParameter("BankId", bankId) :
                new ObjectParameter("BankId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("InsertUpdateBankInfo", bankIdParameter, banknameParameter, companyIdParameter, address1Parameter, address2Parameter, address3Parameter, cityParameter, stateParameter, zipParameter, countryParameter, routingNumberParameter, accountNumberParameter, branchNumberParameter, branchParameter, clearingParameter, cashParameter, suspenseParameter, bankfeesParameter, depositsParameter, sourceCodeIDParameter, currencyCodeParameter, statusParameter, postiivePayParameter, prodidParameter, createdByParameter);
        }
        ...
        public virtual ObjectResult<Nullable<int>> InsertupdateJournalEntry(Nullable<int> journalEntryId, string transactionNumber, string source, string description, Nullable<System.DateTime> entryDate, Nullable<decimal> debitTotal, Nullable<decimal> creditTotal, Nullable<int> totalLines, Nullable<decimal> imbalanceAmount, string auditStatus, Nullable<System.DateTime> postedDate, string referenceNumber, string batchNumber, Nullable<int> prodId, Nullable<int> createdBy, Nullable<int> closePeriod, Nullable<int> companyId, string documentNo, string currencyTransaction)
        {
            var journalEntryIdParameter = journalEntryId.HasValue ?
                new ObjectParameter("JournalEntryId", journalEntryId) :
                new ObjectParameter("JournalEntryId", typeof(int));
            ...
            var currencyTransactionParameter = currencyTransaction != null ?
                new ObjectParameter("CurrencyTransaction", currencyTransaction) :
                new ObjectParameter("CurrencyTransaction", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("InsertupdateJournalEntry", journalEntryIdParameter, transactionNumberParameter, sourceParameter, descriptionParameter, entryDateParameter, debitTotalParameter, creditTotalParameter, totalLinesParameter, imbalanceAmountParameter, auditStatusParameter, postedDateParameter, referenceNumberParameter, batchNumberParameter, prodIdParameter, createdByParameter, closePeriodParameter, companyIdParameter, documentNoParameter, currencyTransactionParameter);
        }
        ...
        public virtual ObjectResult<Nullable<int>> JournalEntryPayment(Nullable<int> paymentID, Nullable<int> prodID, Nullable<int> userID, string companyCode, string batchNumber)
        {
            var paymentIDParameter = paymentID.HasValue ?
                new ObjectParameter("PaymentID", paymentID) :
                new ObjectParameter("PaymentID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("JournalEntryPayment", paymentIDParameter, prodIDParameter, userIDParameter, companyCodeParameter, batchNumberParameter);
        }
        ...
        {
            ObjectParameter thedataOUT = new ObjectParameter("thedataOUT", "");
            var jSONParametersParameter = jSONParameters != null ?
                new ObjectParameter("JSONParameters", jSONParameters) :
                new ObjectParameter("JSONParameters", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("CRWv2GetCRWData", jSONParametersParameter, thedataOUT);
        }
        ...
        public virtual ObjectResult<Nullable<decimal>> APPOAdd(Nullable<int> pOID, string pONumber, Nullable<int> companyID, Nullable<int> vendorID, string vendorName, Nullable<bool> thirdParty, string workRegion, string description, Nullable<decimal> originalAmount, Nullable<decimal> adjustmentTotal, Nullable<decimal> relievedTotal, Nullable<decimal> balanceAmount, string batchNumber, Nullable<bool> closePOuponPayment, string payby, string status, Nullable<int> createdBy, Nullable<int> prodID, Nullable<System.DateTime> pODate, Nullable<int> closePeriodId, Nullable<bool> requiredTaxCode, string currencyDocument)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("APPOAdd", pOIDParameter, pONumberParameter, companyIDParameter, vendorIDParameter, vendorNameParameter, thirdPartyParameter, workRegionParameter, descriptionParameter, originalAmountParameter, adjustmentTotalParameter, relievedTotalParameter, balanceAmountParameter, batchNumberParameter, closePOuponPaymentParameter, paybyParameter, statusParameter, createdByParameter, prodIDParameter, pODateParameter, closePeriodIdParameter, requiredTaxCodeParameter, currencyDocumentParameter);
        }
        ...
        public virtual ObjectResult<int> PostedCollectionInsert(Nullable<int> userID, string postingType, Nullable<int> prodID)
        {
            var userIDParameter = userID.HasValue ?
                new ObjectParameter("UserID", userID) :
                new ObjectParameter("UserID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<int>("PostedCollectionInsert", userIDParameter, postingTypeParameter, prodIDParameter);
        }

        public virtual ObjectResult<int> PostedCollectionTransactionsInsert(Nullable<int> collectionID, string transactionListJSON, Nullable<int> prodID)
        {
            ...
            var transactionListJSONParameter = transactionListJSON != null ?
                new ObjectParameter("TransactionListJSON", transactionListJSON) :
                new ObjectParameter("TransactionListJSON", typeof(string));

            var prodIDParameter = prodID.HasValue ?
                new ObjectParameter("ProdID", prodID) :
                new ObjectParameter("ProdID", typeof(int));

            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<int>("PostedCollectionTransactionsInsert", collectionIDParameter, transactionListJSONParameter, prodIDParameter);
        }

        public virtual ObjectResult<string> TransactionListbyAccountCode(Nullable<int> prodID, string accountCodes)
        {
            var prodIDParameter = prodID.HasValue ?
                new ObjectParameter("ProdID", prodID) :
                new ObjectParameter("ProdID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("TransactionListbyAccountCode", prodIDParameter, accountCodesParameter);
        }
    
        public virtual ObjectResult<PostCollectionList_Result> PostCollectionList(Nullable<int> prodID, Nullable<int> userID, string postingType)
        {
            var prodIDParameter = prodID.HasValue ?
                new ObjectParameter("ProdID", prodID) :
                new ObjectParameter("ProdID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<PostCollectionList_Result>("PostCollectionList", prodIDParameter, userIDParameter, postingTypeParameter);
        }
    
        public virtual ObjectResult<string> AtlasPRGet(Nullable<int> pREditID, Nullable<int> prodID, Nullable<int> userID)
        {
            var pREditIDParameter = pREditID.HasValue ?
                new ObjectParameter("PREditID", pREditID) :
                new ObjectParameter("PREditID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("AtlasPRGet", pREditIDParameter, prodIDParameter, userIDParameter);
        }
    
        public virtual ObjectResult<AtlasPRList_Result> AtlasPRList(Nullable<int> prodID, string jSONParameters)
        {
            var prodIDParameter = prodID.HasValue ?
                new ObjectParameter("ProdID", prodID) :
                new ObjectParameter("ProdID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<AtlasPRList_Result>("AtlasPRList", prodIDParameter, jSONParametersParameter);
        }
    
        public virtual ObjectResult<string> AtlasPRSave(Nullable<int> pREditID, Nullable<int> prodID, Nullable<int> userID, string jSONPayload)
        {
            var pREditIDParameter = pREditID.HasValue ?
                new ObjectParameter("PREditID", pREditID) :
                new ObjectParameter("PREditID", typeof(int));
            ...
            var jSONPayloadParameter = jSONPayload != null ?
                new ObjectParameter("JSONPayload", jSONPayload) :
                new ObjectParameter("JSONPayload", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("AtlasPRSave", pREditIDParameter, prodIDParameter, userIDParameter, jSONPayloadParameter);
        }
    }
}
